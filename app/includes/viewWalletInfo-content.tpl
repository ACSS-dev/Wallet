  ...
  <section class="block">
    ...
    <div class="col-xs-11">
      <div class="account-help-icon">
        <img class="help" src="images/help.png" alt="" width="16" height="18">
    ...
    <div class="col-xs-12" ng-show='showEnc'>
      ...
      <a class="btn btn-info btn-block" style="max-width: initial; width: 100%;" href="{{blobEnc}}" download="{{encFileName}}" translate="x_Download">
        DOWNLOAD
      </a>
    </div>
    ...
    <div class="col-xs-12" ng-show="wallet.type=='default'">
      ...
      <a class="btn btn-info btn-block" style="max-width: initial; width: 100%;" ng-click="printQRCode()" translate="x_Print">
        Print Paper Wallet
      </a>
    </div>
  </section>
